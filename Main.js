				...
				case 'MouseMove':
					...
					if ((timeStamp - e.lastMouseDown) < 200) {
						...
						if ((_v9.a.$ === 'DragFrom') && (_v9.b.$ === 'Just')) {
							...
							var _v10 = (_Utils_cmp(startIdx, currentIdx) < 0) ? _Utils_Tuple2(
...
var $author$project$Rte$Core$showChar = F8(
	function (selection, selectionStyle, cursor, cursorScreen, typing, idx, fontSizeUnit, ch) {
		...
		var pos = (typing && _Utils_eq(idx, cursor)) ? _List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_List_fromArray(
					[
		...
		var attrs = _Utils_ap(
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Attributes$id(e.editorID),
					A2(
		...
		switch (_v0.$) {
			...
			case 'Edit':
				return A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Lazy$lazy(f)(e.sentry),
							$rtfeldman$elm_css$Html$Styled$Lazy$lazy(g)(e.sentry),
							dummy
						]));
			default:
				return A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Lazy$lazy(f)(e),
							$rtfeldman$elm_css$Html$Styled$Lazy$lazy(g)(
							_Utils_update(
								e,
								{cursorVisible: true}))
						]));
